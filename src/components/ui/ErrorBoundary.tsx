...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        <div className="p-6 bg-white rounded-lg border border-red-200 shadow-md animate-fade-in">
          ...
          {this.state.error && (
            <div className="bg-slate-100 p-3 rounded-lg mb-4 overflow-auto max-h-32">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 transition-colors flex items-center space-x-2 focus-ring"
            >
