...
export const VirtualMessageList: React.FC<VirtualMessageListProps> = ({ 
  ...
  return (
    <div 
      ...
      ref={containerRef}
    >
      <div className="space-y-8"> {/* Increased spacing between messages */}
        {optimisticMessages.map((message, index) => {
          ...
          return (
            <div
              ...
              style={{ 
                position: 'relative',
                zIndex: optimisticMessages.length - index, // Higher z-index for newer messages
              }}
            >
              <TransitionWrapper
                show={true}
      ...
      >
        <button
          ...
          className="fixed bottom-24 right-8 bg-teal-600 dark:bg-teal-700 text-white rounded-full p-3 shadow-lg hover:bg-teal-700 dark:hover:bg-teal-600 transition-colors focus-ring z-50"
